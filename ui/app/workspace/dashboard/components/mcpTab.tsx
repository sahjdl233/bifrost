...
function MCPTabImpl({
	...
	return (
		<div className="grid grid-cols-1 gap-2 lg:grid-cols-2 2xl:grid-cols-3">
			...
			<ChartCard
				title={t("dashboard.mcp.toolCalls", "MCP Tool Calls")}
			...
			{/* MCP Cost */}
			<ChartCard
				title={t("dashboard.mcp.cost", "MCP Cost")}
				...
				legend={
					<div className={CHART_HEADER_LEGEND_CLASS}>
						<span className="flex items-center gap-1">
							...
							<span className="text-muted-foreground">{t("dashboard.common.cost", "Cost")}</span>
						</span>
					</div>
				}
				controls={
			...
			{/* Top 10 MCP Tools */}
			<ChartCard
				title={t("dashboard.mcp.topTools", "Top 10 MCP Tools")}
