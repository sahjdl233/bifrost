			...
			<div className="space-y-1 text-sm">
				<div className="mt-2 flex items-center justify-between gap-4">
					<span className="flex items-center gap-1.5">
						...
						<span className="text-zinc-600 dark:text-zinc-400">{t("logs.chart.total", "Total")}</span>
					</span>
				...
				<div className="flex items-center justify-between gap-4">
					<span className="flex items-center gap-1.5">
						...
						<span className="text-zinc-600 dark:text-zinc-400">{t("logs.chart.success", "Success")}</span>
					</span>
				...
				<div className="flex items-center justify-between gap-4">
					<span className="flex items-center gap-1.5">
						...
						<span className="text-zinc-600 dark:text-zinc-400">{t("logs.chart.error", "Error")}</span>
					</span>
				...
				<div className="flex items-center justify-between gap-4">
					<span className="flex items-center gap-1.5">
						...
						<span className="text-zinc-600 dark:text-zinc-400">{t("logs.chart.cancelled", "Cancelled")}</span>
					</span>
			...
			<Collapsible open={isOpen} onOpenChange={onOpenChange}>
				<div className="flex items-center justify-between">
					<CollapsibleTrigger data-testid="logs-volume-chart-trigger" className="flex items-center gap-2 hover:opacity-80">
						...
						<span className="text-muted-foreground text-sm font-medium">{t("logs.chart.requestVolume", "Request Volume")}</span>
					</CollapsibleTrigger>
					<div className="mr-2 flex items-center gap-4">
						{isOpen && (
							<div className="flex items-center gap-3 text-xs">
								<span className="flex items-center gap-1.5">
									<span className="bg-chart-success h-2 w-2 rounded-full" />
									<span className="text-muted-foreground">{t("logs.chart.success", "Success")}</span>
								</span>
								<span className="flex items-center gap-1.5">
									<span className="bg-chart-error h-2 w-2 rounded-full" />
									<span className="text-muted-foreground">{t("logs.chart.error", "Error")}</span>
								</span>
								<span className="flex items-center gap-1.5">
									<span className="bg-chart-neutral h-2 w-2 rounded-full" />
									<span className="text-muted-foreground">{t("logs.chart.cancelled", "Cancelled")}</span>
								</span>
							</div>
						)}
						{isZoomed && onResetZoom && (
							...
							>
								...
								{t("logs.chart.resetZoom", "Reset zoom")}
							</button>
						)}
					</div>
				</div>
