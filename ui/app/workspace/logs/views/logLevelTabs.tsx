...
export default function LogLevelTabs({ value, onChange, testId }: LogLevelTabsProps) {
	...
	return (
		<div role="group" aria-label={t("logs.levels.minimumLogLevel", "Minimum log level")} className="bg-muted/60 inline-flex gap-0.5 rounded-sm p-0.5" data-testid={testId}>
